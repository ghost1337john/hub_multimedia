...
> Use the dedicated [`auto-deploy`](https://github.com/ghost1337john/hub_multimedia/tree/auto-deploy) branch, then see [`english_docs/auto_deploy/README_AUTOSCRIPT.md`](https://github.com/ghost1337john/hub_multimedia/blob/auto-deploy/english_docs/auto_deploy/README_AUTOSCRIPT.md).
